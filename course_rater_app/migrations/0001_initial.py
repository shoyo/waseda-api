# Generated by Django 2.1.12 on 2019-11-02 13:33

import course_rater_app.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classrooms', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20), size=3)),
                ('sessions', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=20), size=2, validators=[course_rater_app.validators.validate_session]), size=3)),
            ],
        ),
        migrations.CreateModel(
            name='CourseReview',
